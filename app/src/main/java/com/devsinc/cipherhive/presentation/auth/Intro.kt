...
fun IntroPage(page: Int, scope: CoroutineScope, navController: NavController) {
    BoxWithConstraints {
        ConstraintLayout(
            introConstraintSet(), modifier = Modifier
                .fillMaxSize()
            ...
            Row(
                ...
                when (page + 1) {
                    1 -> {
                        HighlightedText(page = page + 1)
                        Spacer(modifier = Modifier.width(8.dp))
                        UnlightedText(page = 2)
                        Spacer(modifier = Modifier.width(8.dp))
                        UnlightedText(page = 3)
                    }

                    2 -> {
                        UnlightedText(page = 1)
                        Spacer(modifier = Modifier.width(8.dp))
                        HighlightedText(page = page + 1)
                        Spacer(modifier = Modifier.width(8.dp))
                        UnlightedText(page = 3)
